...
internal sealed class iOSWebViewAdapter : IWebViewAdapter
{
    ...
    public iOSWebViewAdapter()
        : this(DefaultNavigationSecurityHooks.Instance)
    {
    }

    internal iOSWebViewAdapter(INavigationSecurityHooks securityHooks)
    {
    ...
    public void Initialize(IWebViewAdapterHost host)
    {
        ...
        {
            throw new PlatformNotSupportedException("WKWebView adapter can only be used on iOS.");
        }
