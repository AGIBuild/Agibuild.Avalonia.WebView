...
internal static unsafe partial class Libobjc
{
    ...
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
    public static extern IntPtr intptr_objc_msgSend(IntPtr basePtr, IntPtr selector, int param1, IntPtr param2);
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
    ...
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
    public static extern IntPtr intptr_objc_msgSend_intptr_nuint(IntPtr basePtr, IntPtr selector, IntPtr param1, nuint param2);
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
    ...
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
    public static extern void void_objc_msgSend(IntPtr basePtr, IntPtr selector, nuint param1);
    [DllImport(libobjc, EntryPoint = "objc_msgSend")]
