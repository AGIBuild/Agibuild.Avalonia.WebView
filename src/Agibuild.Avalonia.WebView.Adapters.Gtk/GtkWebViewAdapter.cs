...
internal sealed class GtkWebViewAdapter : IWebViewAdapter
{
    ...
    public Task NavigateToStringAsync(Guid navigationId, string html, Uri? baseUrl) => throw new PlatformNotSupportedException("WebView is not yet supported on Linux/GTK.");
