...
public sealed class SharpHookGlobalShortcutProvider : IGlobalShortcutPlatformProvider
{
    ...
    {
        KeyCode.VcA => ShortcutKey.A, KeyCode.VcB => ShortcutKey.B,
        KeyCode.VcC => ShortcutKey.C, KeyCode.VcD => ShortcutKey.D,
        KeyCode.VcE => ShortcutKey.E, KeyCode.VcF => ShortcutKey.F,
        KeyCode.VcG => ShortcutKey.G, KeyCode.VcH => ShortcutKey.H,
        KeyCode.VcI => ShortcutKey.I, KeyCode.VcJ => ShortcutKey.J,
        KeyCode.VcK => ShortcutKey.K, KeyCode.VcL => ShortcutKey.L,
        KeyCode.VcM => ShortcutKey.M, KeyCode.VcN => ShortcutKey.N,
        KeyCode.VcO => ShortcutKey.O, KeyCode.VcP => ShortcutKey.P,
        KeyCode.VcQ => ShortcutKey.Q, KeyCode.VcR => ShortcutKey.R,
        KeyCode.VcS => ShortcutKey.S, KeyCode.VcT => ShortcutKey.T,
        KeyCode.VcU => ShortcutKey.U, KeyCode.VcV => ShortcutKey.V,
        KeyCode.VcW => ShortcutKey.W, KeyCode.VcX => ShortcutKey.X,
        KeyCode.VcY => ShortcutKey.Y, KeyCode.VcZ => ShortcutKey.Z,

        KeyCode.Vc0 => ShortcutKey.D0, KeyCode.Vc1 => ShortcutKey.D1,
        KeyCode.Vc2 => ShortcutKey.D2, KeyCode.Vc3 => ShortcutKey.D3,
        KeyCode.Vc4 => ShortcutKey.D4, KeyCode.Vc5 => ShortcutKey.D5,
        KeyCode.Vc6 => ShortcutKey.D6, KeyCode.Vc7 => ShortcutKey.D7,
        KeyCode.Vc8 => ShortcutKey.D8, KeyCode.Vc9 => ShortcutKey.D9,

        KeyCode.VcF1 => ShortcutKey.F1, KeyCode.VcF2 => ShortcutKey.F2,
        KeyCode.VcF3 => ShortcutKey.F3, KeyCode.VcF4 => ShortcutKey.F4,
        KeyCode.VcF5 => ShortcutKey.F5, KeyCode.VcF6 => ShortcutKey.F6,
        KeyCode.VcF7 => ShortcutKey.F7, KeyCode.VcF8 => ShortcutKey.F8,
        KeyCode.VcF9 => ShortcutKey.F9, KeyCode.VcF10 => ShortcutKey.F10,
        KeyCode.VcF11 => ShortcutKey.F11, KeyCode.VcF12 => ShortcutKey.F12,
