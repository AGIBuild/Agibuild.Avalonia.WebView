...
internal static class WebViewAdapterFactory
{
    ...
    private static IEnumerable<string> GetCandidateAssemblyNamesForCurrentPlatform()
    {
        ...
        {
            yield return "Agibuild.Avalonia.WebView.Adapters.Windows";
            yield break;
        }

        if (OperatingSystem.IsAndroid())
        {
            yield return "Agibuild.Avalonia.WebView.Adapters.Android";
            yield break;
        }

        yield return "Agibuild.Avalonia.WebView.Adapters.Gtk";
    }
