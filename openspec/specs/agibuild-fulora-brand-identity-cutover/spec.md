## Purpose
Define canonical product identity requirements to ensure all release-facing surfaces use `Agibuild.Fulora` consistently and prevent legacy brand regression.
