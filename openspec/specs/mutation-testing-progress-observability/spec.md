...
Define requirements for mutation testing progress observability, ensuring profile-level execution visibility and deterministic progress summaries in CI.
