## Purpose
Define production-readiness acceptance criteria for the Linux/WebKitGTK adapter, including runtime smoke validation and DevTools inspector wiring for Phase 3 GA readiness.
