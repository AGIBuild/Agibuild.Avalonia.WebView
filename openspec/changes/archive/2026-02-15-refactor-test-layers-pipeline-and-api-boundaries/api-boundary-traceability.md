...
| Package-consumption boundary (`Agibuild.Avalonia.WebView` + transitive dependencies) | `BuildPipelineGovernance` checks in unit tests | `build/Build.cs::NugetPackageTest` smoke flow | Closed |
