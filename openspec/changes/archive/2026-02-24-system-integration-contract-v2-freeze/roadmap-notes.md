...
- Reserved metadata key registry and deterministic deny taxonomy.
- Canonical inbound timestamp wire semantics for system-integration events.
- Template runtime ShowAbout opt-in marker with default deny baseline.
- Governance + CT matrix updates for freeze branch evidence.
