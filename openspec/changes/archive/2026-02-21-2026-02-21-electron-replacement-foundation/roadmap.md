# Roadmap — Web-First Foundation (Draft)

## Vision

构建面向 AI 时代的软件开发架构：  
让团队使用 Web 技术（TypeScript + modern frontend）开发跨平台桌面应用，并系统性解决打包式桌面栈在类型安全、能力治理、自动化验证和工程复杂度上的痛点。

## Milestones

| Milestone | Window | Exit Criteria |
|---|---|---|
| M0 Objective Reset | Week 1 | 路线从“多宿主复用”切换为“web-first 痛点闭环”并锁定验收指标 |
