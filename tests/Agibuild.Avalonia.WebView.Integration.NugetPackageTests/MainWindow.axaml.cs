...
public partial class MainWindow : Window
{
    ...
    private async Task RunSmokeTestAsync()
    {
        try
        {
            // ── Step 1: Agibuild.Avalonia.WebView — WebView created via XAML ──
            UpdateStatus($"Step 1/{TotalSteps}: WebView created via XAML (DI initialized).");
            await Task.Delay(1000);

            // ── Step 2: Agibuild.Avalonia.WebView — HTML navigation ──
            ...
            // ── Step 3: Agibuild.Avalonia.WebView — JavaScript execution ──
            ...
            // ── Step 4: Agibuild.Avalonia.WebView.Core — MockBridgeService + [JsExport] ──
            ...
            // ── Step 5: Agibuild.Avalonia.WebView.Core — MockBridgeService + [JsImport] proxy ──
            ...
            // ── Step 6: Agibuild.Avalonia.WebView.Bridge.Generator — source-gen verification ──
