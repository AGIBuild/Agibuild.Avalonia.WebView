...
internal static class AvaloniaHeadlessXunitV3Runtime
{
    ...
    {
        var fallback = Type.GetType("Agibuild.Avalonia.WebView.Integration.Tests.Automation.TestAppBuilder, Agibuild.Avalonia.WebView.Integration.Tests.Automation");
