...
public class SettingsServiceTests
{
    ...
    {
        // Use temp file in AvaloniVue folder to avoid polluting real settings
        var tmpDir = Path.Combine(Path.GetTempPath(), "AvaloniVue");
        Directory.CreateDirectory(tmpDir);
        var tmpFile = Path.Combine(tmpDir, $"settings-test-{Guid.NewGuid():N}.json");
